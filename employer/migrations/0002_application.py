    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('applied', 'applied'), ('accepted', 'accepted'), ('rejected', 'rejected'), ('pendind', 'pending'), ('cancelled', 'cancelled')], default='applied', max_length=120)),
